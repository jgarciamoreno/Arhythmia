...
public struct Line {
    ...
    public Line (Vector2 pointOnLine, Vector2 pointPerpecdicularToLine)
    {
        float dx = pointOnLine.x - pointPerpecdicularToLine.x;
        float dy = pointOnLine.y - pointPerpecdicularToLine.y;
        ...
        approachSide = false;
        approachSide = getSide(pointPerpecdicularToLine);
    }
